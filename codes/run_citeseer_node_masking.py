...
opt['dataset'] =  '../data/citeseer' # '../data/citeseer'
opt['hidden_dim'] = 16
...
if drop_node_accuracy:
    opt['log'] = 'citeseer_node_masking_{}_dropout_accuracy.txt'.format(drop_rate)
else:
    opt['log'] = 'citeseer_node_masking_{}.txt'.format(drop_rate)
